...
# #####################################
# # TEST RADIAL CONVERSION TO netCDF
# #####################################

radial_file = '../test/test_HFRadarPy/data/radials/ruv/TINO/RDLm_TINO_2021_01_08_0800.ruv'
radial_file = '../test/test_HFRadarPy/data/radials/ruv/FORM/RDLm_FORM_2018_12_05_0000_TEST.ruv'
...
# test functions for netCDF conversion
dsW = RW.to_xarray_multidimensional()

numberOfRangeCells = 79
ds = R.to_xarray_multidimensional(0,float(R.metadata['RangeResolutionKMeters'].split()[0])*(numberOfRangeCells-1))
